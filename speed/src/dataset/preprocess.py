...
class Preprocess():
    def __init__(self,tokenizer,mtokenizer):
        self.tokenizer=tokenizer
        self.mtokenizer=mtokenizer
    ...
    def __call__(self,examples):
        ...
        prompt = self.mtokenizer.apply_chat_template(messages, tokenize=False, add_generation_prompt=True)
