...
class ModelArguments:
    def __init__(self):
        ...
        self.logging_dir="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/yuandl/Open/remamba/hope-llama3b-longctx/log/llama3b-long"
        self.tokenizer= "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/yuandl/LLMs/openlm-research/open_llama_3b_v2template"
        self.modelpath = "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/yuandl/LLMs/openlm-research/open_llama_3b_v2"
        self.output_dir= "/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/yuandl/Open/remamba/hope-llama3b-longctx/out/llama3b-long"
        self.lora=32
        self.dataset_name='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/yuandl/dataset/NormalOrcaRemambag2048'
        self.longdataset_name='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/yuandl/dataset/LongContextRemambag2048'
...
def main():
    ...
    training_args = TrainingArguments(
        deepspeed="deepspeedcfg/ds_config_zero3.json",
                                      ...
                                      report_to="tensorboard",do_eval=True,gradient_checkpointing=True,
